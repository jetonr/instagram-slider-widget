 ...
 */
(function (e) {
    e.pllexislider = function (t, n) {
        var r = e(t);
        r.vars = e.extend({}, e.pllexislider.defaults, n);
        ...
        v = {
                ...
                setup: function () {
                    ...
                    if (!s) {
                        r.slides.click(function (t) {
                            ...
                            } else if (!e(r.vars.asNavFor).data("pllexislider").animating && !n.hasClass(i + "active-slide")) {
                        ...
                        r.slides.each(function () {
                            ...
                            t.addEventListener("MSGestureTap", function (t) {
                                ...
                                var n = e(this),
                                    i = n.index();
                                if (!e(r.vars.asNavFor).data("pllexislider").animating && !n.hasClass("active")) {
            ...
            sync: function (t) {
                var n = e(r.vars.sync).data("pllexislider"),
                    i = r.animatingTo;
                switch (t) {
                case "animate":
        ...
        r.flexAnimate = function (t, n, s, u, a) {
            ...
            if (!r.animating && (r.canAdvance(t, a) || s) && r.is(":visible")) {
                if (d && u) {
                    var f = e(r.vars.asNavFor).data("pllexislider");
    ...
    e.fn.pllexislider = function (t) {
        ...
        if (typeof t === "object") {
            return this.each(function () {
                ...
                } else if (n.data("pllexislider") === undefined) {
                    new e.pllexislider(this, t)
                }
            })
        } else {
            var n = e(this).data("pllexislider");
            switch (t) {
            case "play":
                n.play();
                break;
